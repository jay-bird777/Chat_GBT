...
class QRegularExpression(PyQt6.sip.simplewrapper):
    ...
    def globalMatch(self, subject: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ..., matchOptions: 'QRegularExpression.MatchOption' = ...) -> 'QRegularExpressionMatchIterator': ...
    ...
    def match(self, subject: str, offset: int = ..., matchType: 'QRegularExpression.MatchType' = ..., matchOptions: 'QRegularExpression.MatchOption' = ...) -> 'QRegularExpressionMatch': ...
...
class QUuid(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def __init__(self, string: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
...
class QXmlStreamReader(PyQt6.sip.simplewrapper):
    ...
    def __init__(self, device: QIODevice) -> None: ...
    @typing.overload
    def __init__(self, data: typing.Union[QByteArray, str]) -> None: ...
    ...
    def atEnd(self) -> bool: ...
    def clear(self) -> None: ...
    def addData(self, data: typing.Union[QByteArray, str]) -> None: ...
    def device(self) -> QIODevice: ...
    def setDevice(self, device: QIODevice) -> None: ...
...
class QXmlStreamWriter(PyQt6.sip.simplewrapper):
    ...
    @typing.overload
    def writeStartElement(self, namespaceUri: typing.Union[QByteArray, str], name: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeStartElement(self, qualifiedName: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeStartDocument(self, version: typing.Union[QByteArray, str], standalone: bool) -> None: ...
    @typing.overload
    def writeStartDocument(self, version: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeStartDocument(self) -> None: ...
    def writeProcessingInstruction(self, target: typing.Union[QByteArray, str], data: typing.Union[QByteArray, str] = ...) -> None: ...
    def writeDefaultNamespace(self, namespaceUri: typing.Union[QByteArray, str]) -> None: ...
    def writeNamespace(self, namespaceUri: typing.Union[QByteArray, str], prefix: typing.Union[QByteArray, str] = ...) -> None: ...
    def writeEntityReference(self, name: typing.Union[QByteArray, str]) -> None: ...
    def writeEndElement(self) -> None: ...
    def writeEndDocument(self) -> None: ...
    @typing.overload
    def writeTextElement(self, namespaceUri: typing.Union[QByteArray, str], name: typing.Union[QByteArray, str], text: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeTextElement(self, qualifiedName: typing.Union[QByteArray, str], text: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeEmptyElement(self, namespaceUri: typing.Union[QByteArray, str], name: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeEmptyElement(self, qualifiedName: typing.Union[QByteArray, str]) -> None: ...
    def writeDTD(self, dtd: typing.Union[QByteArray, str]) -> None: ...
    def writeComment(self, text: typing.Union[QByteArray, str]) -> None: ...
    def writeCharacters(self, text: typing.Union[QByteArray, str]) -> None: ...
    def writeCDATA(self, text: typing.Union[QByteArray, str]) -> None: ...
    def writeAttributes(self, attributes: 'QXmlStreamAttributes') -> None: ...
    @typing.overload
    def writeAttribute(self, namespaceUri: typing.Union[QByteArray, str], name: typing.Union[QByteArray, str], value: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
    def writeAttribute(self, qualifiedName: typing.Union[QByteArray, str], value: typing.Union[QByteArray, str]) -> None: ...
    @typing.overload
