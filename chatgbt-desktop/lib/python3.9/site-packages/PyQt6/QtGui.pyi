...
class QShortcutEvent(QtCore.QEvent):
    ...
    @typing.overload
    def __init__(self, key: typing.Union['QKeySequence', 'QKeySequence.StandardKey', str, int], shortcut: typing.Optional['QShortcut'] = ..., ambiguous: bool = ...) -> None: ...
...
class QUtiMimeConverter(PyQt6.sip.simplewrapper):
    ...
    def convertToMime(self, mime: str, data: typing.Iterable[QtCore.QByteArray], uti: str) -> typing.Any: ...
    def mimeForUti(self, uti: str) -> str: ...
    def utiForMime(self, mime: str) -> str: ...
    def convertFromMime(self, mime: str, data: typing.Any, uti: str) -> typing.List[QtCore.QByteArray]: ...
    def canConvert(self, mime: str, uti: str) -> bool: ...
